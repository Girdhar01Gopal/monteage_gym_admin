...
class AdminDailyCollectionController extends GetxController {
  ...
  void fetchCollectionData(String collectionType) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['statuscode'] == 200 && data['data'] != null) {
        ...
        Get.snackbar(
          "Today's Summary",
          'No data found for $collectionType\' collection',
          backgroundColor: Colors.red,
          colorText: Colors.white,
        );
      }
    } else {
      Get.snackbar('Error', 'Failed to load $collectionType\' collection data',
  ...
  void openEditDialog(Map<String, dynamic> data, bool isToday) {
    ...
    final nextPaymentController = TextEditingController(text: formatDate(data['NextPaymentDate']));
    final progressController = TextEditingController(text: data['PaymentStatus']);
    final dateController = TextEditingController(text: formatDate(data['PaymentDate']));
  ...
  // Method to format date as dd-mm-yyyy and remove T00:00:00
